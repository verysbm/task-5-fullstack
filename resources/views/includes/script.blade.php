<!-- latest jquery-->
<script src="{{url("back/assets/js/jquery-3.5.1.min.js")}}"></script>
<!-- Bootstrap js-->
...
<!-- Plugins JS start-->
<script src="{{url("back/assets/js/chart/chartist/chartist-plugin-tooltip.js")}}"></script>
...
<script src="{{url("back/assets/js/chart/apex-chart/apex-chart.js")}}"></script>
<script src="{{url("back/assets/js/chart/apex-chart/stock-prices.js")}}"></script>
<script src="{{url("back/assets/js/dashboard/default.js")}}"></script>
<script src="{{url("back/assets/js/datepicker/date-picker/datepicker.js")}}"></script>
<script src="{{url("back/assets/js/datepicker/date-picker/datepicker.en.js")}}"></script>
<script src="{{url("back/assets/js/datepicker/date-picker/datepicker.custom.js")}}"></script>
